const DestinationsHero = () => {
  return (
    <section className="pt-40 sm:pt-48 md:pt-64 pb-16 sm:pb-24 md:pb-32 bg-brand-bg-primary relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        <span className="text-brand-red font-black uppercase tracking-[0.5em] text-xs mb-4 md:mb-8 block">Interactive Hub</span>
